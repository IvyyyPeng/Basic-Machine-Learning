...
design_doc.docx. explain the overall design idea and the algorithm, including 
(a) how the closest neighbors are chosen and 
(b) the rule(s) used in making the prediction. 
...
digit-predicting.txt: prediction data set with size 8. Use the chosen model to recognize numbers.
...
Then the output will be printed in the console. 
